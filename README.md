...
🔗 Demo: agrega aquí tu link de GitHub Pages una vez publicado
...
🕹️ Cómo usarlo
Abre index.html en el navegador (o entra al link de GitHub Pages).
Haz click en los días del heatmap para ir marcando tu avance. ✅
Todo se guarda en localStorage del navegador — no requiere cuenta ni servidor. 🔒
🌐 Publicarlo con GitHub Pages
Sube este archivo a un repositorio público.
Ve a Settings → Pages.
En Branch selecciona main y carpeta / (root).
Guarda. En 1-2 minutos tu sitio queda disponible en tu-usuario.github.io/nombre-repo/. 🎉
🛠️ Notas técnicas
