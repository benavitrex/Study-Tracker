...
- **Ponderación de la carrera objetivo** (Ing. Civil Industrial – PUCV): NEM, ranking, M1, M2, Comprensión Lectora, Historia.
...
- **Horario semanal**: vista tipo calendario (lunes a domingo) con todos los bloques de clases, estudio autónomo y ensayos.
